                ...
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_ifo_area">
                            <form action="user_alter">
                                <input name="id" value="${sessionScope.user.id}" type="hidden">
                                <div class="form_group">
                                    <span class="dd">昵　称：</span>
                                    <input name="nickname" type="text" value="${sessionScope.user.nickname}">
                                ...
                                <div class="form_group">
                                    ...
                                    <input name="birthday" type="text" value="${sessionScope.user.birthday}">
                                </div>
                                <div class="form_group">
                                    <span class="dd">邮　箱：</span>
                                    <input name="accounts" type="text" value="${sessionScope.user.accounts}" readonly="readonly">
                                </div>
                                <div class="form_group">
                                ...
                                <div class="form_submit dd">
                                    ...
                                    <a href="user_update?service=data">重置</a>
                                </div>
